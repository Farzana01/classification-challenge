...
This challenge is to evaluate which supervised ML model is the best to detect spam emails and filter them out of a customer's inbox. The two classification models that will be compared are logistic regression and random forest model. 
